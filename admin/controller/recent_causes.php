...
class DS_Admin_recent_causes
{
    ...
    function ds_recent_causes_post_type_registration_init()
    {
        $labels = array(
            'name'                  => _x('Recent causes', 'Post type general name', 'general_plugin'),
            'singular_name'         => _x('Factory', 'Post type singular name', 'general_plugin'),
            'menu_name'             => _x('Recent causes', 'Admin Menu text', 'general_plugin'),
            'name_admin_bar'        => _x('Factory', 'Add New on Toolbar', 'general_plugin'),
            ...
            'featured_image'        => _x('Factory Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'general_plugin'),
            ...
            'archives'              => _x('Factory archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'general_plugin'),
            ...
            'items_list_navigation' => _x('Recent causes list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'general_plugin'),
            'items_list'            => _x('Recent causes list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'general_plugin'),
        );
        $args = array(
            'labels'             => $labels,
            'description'        => 'Recent causes custom post type.',
            'public'             => true,
            'publicly_queryable' => true,
            'show_ui'            => true,
            'show_in_menu'       => true,
            'query_var'          => true,
            'rewrite'            => array('slug' => 'recent_causes'),
        ...
        register_post_type('recent_causes', $args);
    }
}
