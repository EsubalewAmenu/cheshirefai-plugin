...
class DS_Admin_Gallery
{
    ...
    function ds_gallery_post_type_registration_init()
    {
        $labels = array(
            'name'                  => _x('Gallery', 'Post type general name', 'general_plugin'),
            'singular_name'         => _x('Factory', 'Post type singular name', 'general_plugin'),
            'menu_name'             => _x('Gallery', 'Admin Menu text', 'general_plugin'),
            ...
            'items_list_navigation' => _x('Gallery list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'general_plugin'),
            'items_list'            => _x('Gallery list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'general_plugin'),
        );
        $args = array(
            'labels'             => $labels,
