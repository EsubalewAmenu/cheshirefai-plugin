     ...
     <section class="container-fluid causes">
        ...
        <div class="cuses-row row">
            <div class="col-md-4">
                ...
                <div class="caus-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/causes/c1.jpg" alt="">
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="caus-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/causes/c2.jpg" alt="">
                </div>
                <div class="caus-info row no-margin">
                    <span class="left-info col-6">
                        RAISED: $764
            ...
            <div class="col-md-4">
                ...
                <div class="caus-img">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/causes/c3.jpg" alt="">
                </div>
                <div class="caus-info row no-margin">
                    <span class="left-info col-6">
                        RAISED: $764
